function [I,labels,I_test,labels_test] = readMNIST(num, path)
...
%============Loading labels
filepath = fullfile(path,'train-labels.idx1-ubyte');
if(~exist(filepath,'file'))
...
filepath = fullfile(path,'t10k-images.idx3-ubyte');
if(~exist(filepath,'file'))
...
%============Test labels
filepath = fullfile(path,'t10k-labels.idx1-ubyte');
if(~exist(filepath,'file'))
